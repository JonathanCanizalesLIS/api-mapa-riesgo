...
namespace ElectronicDataInterchange.API.Classes.Autenticacion
{
    ...
    {
        public static string DesencriptaPass(string cipherText, string passPhrase, string saltValue, string hashAlgorithm, int passwordIterations, string initVector, int keySize)
        {
